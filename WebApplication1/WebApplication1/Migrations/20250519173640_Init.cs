    ...
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Only 1 per day", "Aspirin", "Treat pain" },
                    { 2, "Max 3 per day", "Ibuprom", "Treat headache" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, new DateTime(1999, 5, 2, 0, 0, 0, 0, DateTimeKind.Unspecified), "Jonathan", "Boe" },
                    { 2, new DateTime(1980, 1, 19, 0, 0, 0, 0, DateTimeKind.Unspecified), "Ann", "Boe" }
                });
